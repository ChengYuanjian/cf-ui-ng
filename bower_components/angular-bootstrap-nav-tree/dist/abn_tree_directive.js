    ...
    '$timeout', function($timeout) {
      return {
        ...
        scope: {
          ...
          onSelect: '&',
          initialSelection: '@',
          selectText: '=',//add by mas 20160822
          treeControl: '='
        },
        link: function(scope, element, attrs) {
          ...
          if (attrs.iconExpand == null) {
            attrs.iconExpand = 'fa fa-plus icon text-info-dker';
          }
          if (attrs.iconCollapse == null) {
            attrs.iconCollapse = 'fa fa-minus icon text-info-dker';
          }
          if (attrs.iconLeaf == null) {
            attrs.iconLeaf = 'fa fa-cube icon text-info-dker';
          }
          ...
          select_branch = function(branch) {
            ...
            // modify by mas 20160826 点击同一个树节点也会重新刷新
          ...
          on_treeData_change = function() {
            ...
            add_branch_to_list = function(level, branch, visible) {
              ...
              if (branch.expanded == null) {
                //modify by mas 20160826 切换节点时自动展开
